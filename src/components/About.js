...
import profileUpdate from '../GD/profileUpdate.jpg'
        ...
        <div className={this.state.MediaQueryAbout + ' ' + this.state.aboutFadeOut} style={pageLoadingStatus}>
          ...
          <div className="wrapper">
            <div className="imageContainer">
                ...
                <img className={this.state.profileCss + ' ' + this.state.aboutFadeIn} alt="reload" src={profileUpdate}></img>
